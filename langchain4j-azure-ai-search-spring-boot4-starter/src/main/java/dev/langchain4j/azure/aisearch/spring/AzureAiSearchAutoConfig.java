...
import static dev.langchain4j.azure.aisearch.spring.AzureAiSearchProperties.PREFIX;
...
public class AzureAiSearchAutoConfig {
    ...
    public AzureAiSearchContentRetriever azureAiSearchContentRetriever(AzureAiSearchProperties properties, @Nullable EmbeddingModel embeddingModel, @Nullable SearchIndex index) {
        AzureAiSearchProperties.NestedProperties nestedProperties = properties.getContentRetriever();
    ...
    public AzureAiSearchEmbeddingStore azureAiSearchEmbeddingStore(AzureAiSearchProperties properties, @Nullable EmbeddingModel embeddingModel, @Nullable SearchIndex index) {
        AzureAiSearchProperties.NestedProperties nestedProperties = properties.getEmbeddingStore();
